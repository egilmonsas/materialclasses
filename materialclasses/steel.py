...
classes = {
    ...
    "S 460 Q/QL/QL1":   SteelClass(standard="NS-EN 10025-6", variant="S 355 W", fy=460, fu=570, fy_t=440, fu_T=550),
    "S 235 H":          SteelClass(standard="NS-EN 10021-1", variant="S 235 H", fy=235, fu=360, fy_t=215, fu_T=340),
    "S 275 H":          SteelClass(standard="NS-EN 10021-1", variant="S 275 H", fy=275, fu=430, fy_t=255, fu_T=410),
    "S 355 H":          SteelClass(standard="NS-EN 10021-1", variant="S 355 H", fy=355, fu=510, fy_t=335, fu_T=490),
    "S 275 NH/NLH":     SteelClass(standard="NS-EN 10021-1", variant="S 275 NH/NLH", fy=275, fu=390, fy_t=255, fu_T=370),
    "S 355 NH/NLH":     SteelClass(standard="NS-EN 10021-1", variant="S 355 NH/NLH", fy=355, fu=490, fy_t=335, fu_T=470),
    "S 420 NH/NLH":     SteelClass(standard="NS-EN 10021-1", variant="S 420 NH/NLH", fy=420, fu=540, fy_t=390, fu_T=520),
    "S 460 NH/NLH":     SteelClass(standard="NS-EN 10021-1", variant="S 460 NH/NLH", fy=460, fu=560, fy_t=430, fu_T=550),
}
# fmt: on
